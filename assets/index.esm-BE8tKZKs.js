 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xe{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Qe(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Qe(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const S="@firebase/app",x="0.15.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ut(t){P(new I("platform-logger",e=>new Xe(e),"PRIVATE")),P(new I("heartbeat",e=>new kt(e),"PRIVATE")),w(S,x,t),w(S,x,"esm2020"),w("fire-js","")}Ut("");export{Wt as A,Vt as B,ne as C,A as D,Yt as E,C as F,qt as G,te as H,se as I,l as J,jt as K,Pe as L,Kt as M,Ce as N,Jt as O,Gt as P,I as Q,en as R,ln as S,J as _,sn as a,g as b,cn as c,v as d,At as e,le as f,an as g,Ot as h,P as i,on as j,E as k,Mt as l,fn as m,dn as n,Rt as o,hn as p,un as q,w as r,pn as s,Qt as t,Zt as u,Xt as v,tn as w,N as x,nn as y,rn as z};
