...
assert.match(
  scheduleRowA,
  // Owner 2026-09-25: the schedule prints the standard spacing the engine
  // verified at that spacing and keeps the exact value in the attribute.
  new RegExp(`data-exact-value="${defaultRebarA.spacingMm}">${defaultRebarA.nominalSpacingMm} mm<`),
  'schedule spacing prints the standard spacing while retaining the exact Snapshot value'
)
assert.match(
  scheduleRowA,
  new RegExp(
